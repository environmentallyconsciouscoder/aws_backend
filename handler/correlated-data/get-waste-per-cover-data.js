...
export const main = (event, context, callback) => {
    ...
    response.promise().then((data) => {
        coverInputsData = data.Items;
        // console.log("covers input data",coverInputsData);
        ...
        response.promise().then((data) => {
            ...
            //give all the inputs for this week starting from a monday
            ...
            return callback(null, success(wastePerCover));
        });
    }).catch((err) => {
        console.log("err", err);
        return failure(err);
